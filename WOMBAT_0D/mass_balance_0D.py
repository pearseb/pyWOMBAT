...
def massb_n(no3, phy, zoo, det, \
            thresh):
    tot_n0 = no3[0] + phy[0] + zoo[0] + det[0]
...
def massb_c(dic, cal, phy, zoo, det, C2N, \
            thresh):
    tot_c0 = dic[0] + cal[0] + (phy[0] + zoo[0] + det[0]) * C2N
    tot_c1 = dic[1] + cal[1] + (phy[1] + zoo[1] + det[1]) * C2N
...
def massb_f(dfe, phy, zoo, det, Fe2N, \
            thresh):
    tot_f0 = dfe[0] + (phy[0] + zoo[0] + det[0]) * Fe2N
    tot_f1 = dfe[1] + (phy[1] + zoo[1] + det[1]) * Fe2N
