...
def plot_1D_2P2Z_nh4(o2,nh4,no3,dfe,phy,dia,zoo,mes,det,poc,cal,\
                     pchl,dchl,phyfe,diafe,detfe,pocfe,zoofe,mesfe,pgi_zoo,pgi_mes,z_zgrid):
    ...
    ax1 = plt.subplot(gs[0,0]) # O2
    ax2 = plt.subplot(gs[0,1]) # NH$ + NO3 + dFe
    ax3 = plt.subplot(gs[0,2]) # Phy + Zoo + Det + POC
    ax4 = plt.subplot(gs[1,0]) # chl:C ratio of PHY
    ax5 = plt.subplot(gs[1,1]) # Fe:C ratios
    ax6 = plt.subplot(gs[1,2]) # grazing pressure
    ...
    ax2.plot(nh4, z_zgrid, color=col1, label=lab2a)
    ax2.plot(no3, z_zgrid, color=col2, label=lab2b)
    ax2.plot(dfe*1e3, z_zgrid, color=col3, label=lab3)
    ax2.legend()
    ...
    ax3.plot(zoo, z_zgrid, color=col2, label=lab6)
    ax3.plot(mes, z_zgrid, color=col2, label=lab7, linestyle=lst2)
    ax3.plot(det, z_zgrid, color=col3, label=lab8a)
    ax3.plot(poc, z_zgrid, color=col3, label=lab8b, linestyle=lst2)
    ax3.legend()
    ...
    ax5.plot(mesfe, z_zgrid, color=col2, label=lab14, linestyle=lst2)
    ax5.plot(detfe, z_zgrid, color=col3, label=lab15)
    ax5.plot(pocfe, z_zgrid, color=col3, label=lab16, linestyle=lst2)
    ax5.set_xlim(0,80)
    ax5.legend()
    
    ax6.plot(pgi_zoo, z_zgrid, color=col2, label=lab17)
    ax6.plot(pgi_mes, z_zgrid, color=col2, label=lab18, linestyle=lst2)
    ax6.legend()
